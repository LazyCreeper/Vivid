...
<template>
  ...
  >
    <el-scrollbar>
      ...
      <el-menu-item-group>
        <template #title>Theme by <a href="https://www.lazy.ink" target="_blank">Lazy</a></template>
      </el-menu-item-group>
...
.el-menu-item:hover {
  ...
  background-color: rgb(46, 195, 240);
  box-shadow: 0 0 10px #46d4ff;
  color: #fff;
  border-radius: 25px; 
}
...
.el-menu-item.is-active {
  background: linear-gradient(to right, #49BCFC, #3B92F8);
  box-shadow: 0 0 8px 0px #4cd5ff;
  border-radius: 25px;
  color: #fff!important;
}
</style>
